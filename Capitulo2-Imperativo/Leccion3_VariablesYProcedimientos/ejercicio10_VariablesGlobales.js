/*
definí una función ascensorSobrecargado, que toma una cantidad de 
...
function ascensorSobrecargado(cant){
	return(cant*pesoPromedioPersonaEnKilogramos > cargaMaximaEnKilogramos);
}
